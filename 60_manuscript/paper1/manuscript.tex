...
\subsection{Re-validation}
\pending{Full 12-case re-validation with the adopted force field, including transport properties and
the hydroxide--water radial distribution function. The first completed cases give
\SI{1.1731}{\gram\per\cubic\centi\metre} at 20\,wt\% ($-1.0\,\%$) and
\SI{1.2688}{\gram\per\cubic\centi\metre} at 30\,wt\% ($-1.3\,\%$), both inside the gate; the
remaining cases and the transport stage are running at the time of writing.}
